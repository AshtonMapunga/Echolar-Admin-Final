    ...
    async processITInput(message, session, phoneNumber) {
        ...
        switch (session.state) {
            case this.IT_STATES.COLLECT_COMPANY_NAME:
                session.applicationData.companyName = message.trim(); // Keep original case for company name
            ...
            case this.IT_STATES.COLLECT_CONTACT_NAME:
                session.applicationData.contactName = message.trim(); // Keep original case for name
            ...
            case this.IT_STATES.COLLECT_PHONE:
                session.applicationData.phoneNumber = message.trim(); // Keep original formatting for phone
